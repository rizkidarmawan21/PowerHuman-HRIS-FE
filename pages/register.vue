    ...
    <section class="py-[50px] flex flex-col items-center justify-center px-4">
        ...
        <form class="w-full card" @submit.prevent="userRegister">
            <div class="form-group">
                <label for="" class="text-grey">Your Name</label>
                <input type="text" class="input-field" autofocus v-model="register.name">
            </div>
            <div class="form-group">
            ...
            <!-- <NuxtLink to="login" class="w-full btn btn-primary mt-[14px]">
                Continue
            </NuxtLink> -->
